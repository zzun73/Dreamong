...
public class CategoryController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<Map<Type, List<Category>>>> getTop3CategoriesByType() {
        Map<Type, List<Category>> topCategoriesByType = categoryService.getTop3CategoriesByType();
