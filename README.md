...
| 로그인 화면| 로그인 화면 |  |  |
| --- | --- | --- | --- |
| ![로그인](README_asset/1.%20로그인화면_1.png) | ![로그인](README_asset/1.%20로그인화면_2.png) | ![로그인](README_asset/빈페이지.png) | ![로그인](README_asset/빈페이지.png) |
| - [로그인 화면] : 소셜 로그인을 통해 로그인을 할 수 있다. | - [로그인 화면] : 소셜 로그인을 통해 로그인을 할 수 있다. |  |  |
...
- **OKHttps3** : - 기본적으로 효율적인 HTTP 클라이언트
  HTTP 기반의 request/response를 할 수 있도록 도와주는 오픈 소스 라이브러리 - 실시간 서버 연결
