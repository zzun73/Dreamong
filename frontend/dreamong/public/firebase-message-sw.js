...
function initializeFirebase() {
  if (!firebase.apps.length) {
    firebase.initializeApp({
      apiKey: self.__WB_MANIFEST.env.VITE_FB_API_KEY,
      authDomain: self.__WB_MANIFEST.env.VITE_FB_AUTH_DOMAIN,
      projectId: self.__WB_MANIFEST.env.VITE_FB_PROJECT_ID,
      storageBucket: self.__WB_MANIFEST.env.VITE_FB_STORAGE_BUCKET,
      messagingSenderId: self.__WB_MANIFEST.env.VITE_FB_MESSAGING_SENDER_ID,
      appId: self.__WB_MANIFEST.env.VITE_FB_APP_ID,
      measurementId: self.__WB_MANIFEST.env.VITE_MEASUREMENT_ID,
    });
  }
